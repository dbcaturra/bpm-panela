...
urlservice = "/admin/job"#service for the authorized redirect
GOOGLE_ID = '637895219172-sma8n5o1pup6cb7jm3940v5pcfj428q3.apps.googleusercontent.com'
GOOGLE_SECRET = 'b52VtRe11etFPKv98xWrf4dZ'
...
def login():
    return google.authorize(callback=url_for('adminauth.authorized', _external=True))

@adminauth.route('/login/authorized')
def authorized():
